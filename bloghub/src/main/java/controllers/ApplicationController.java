...
public class ApplicationController {
    ...
    public Result newFeature() {
       ...
       if(RedisController.getFlag())
        {
            //return Results.html().template("views/ApplicationController/new.ftl.html");
            //return Results.html();
        ...
        else 
        {
           ...
           // else return Results.html().template("views/ApplicationController/new.ftl.html");*/
    }
